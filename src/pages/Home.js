        ...
        <>
            ...
            >
                <div className="flex pt-[60px] flex-col items-center md:space-y-[50px] space-y-[70px]  justify-center">
                    ...
                    <span className="bg-purple-600 md:hover:shadow-xl text-white text-base font-aeion px-10 py-4 rounded-full cursor-pointer md:hover:bg-blue-700 transition duration-300">
            ...
            < h1 className="xl:text-[65px] md:text-[50px] max-w-screen  leading-10 text-center text-[25px] md:h-screen md:leading-tight md:py-[100px] md:px-[80px] px-[20px] py-[50px] font-semibold font-aeion md:tracking-wider xl:text-left flex items-center md:justify-center" >
            ...
            <div div  className="bg-gray-100 max-w-screen flex flex-col justify-center space-y-14 items-center md:py-[40px] md:px-4 px-[20px] py-[50px]" >
                ...
                <h1 className="bg-gray-50 border-gray-800 border md:border-gray-200 px-5 font-normal py-1 md:hover:bg-gray-200 md:hover:shadow-xl rounded-full transition cursor-pointer">View All Services</h1>
            </div >
            ...
            {/* fifth section */}
            < div className="bg-gray-100 max-w-screen flex flex-col justify-center md:space-y-14 space-y-5 items-center md:py-[80px] py-[50px] px-[20px] md:px-4" >
                ...
                <div className="max-w-6xl w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    {[
                        ...
                        >
                            ...
                            <h2 className="md:text-6xl text-3xl font-bold text-purple-700 mb-2 md:mb-4">{item.number}</h2>
            ...
            {/* sixth section */}
            <div  className=" flex flex-col max-w-screen justify-center md:space-y-14 space-y-5 items-center md:py-[80px] md:px-4 px-[20px] py-[50px]" >
                ...
                <div className="max-w-[1220px] w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                    {[
                        ...
                        <div
                            ...
                            className="rounded-2xl shadow-xl md:shadow-none z-1 border  bg-gradient-to-t from-[#fbfbfb] via-[#fbfbfb] to-white overflow-hidden p-6  flex flex-col items-start justify-start text-left relative hover:shadow-xl cursor-pointer md:transform md:transition-transform md:duration-300 md:hover:scale-105"
                        >
            ...
            {/* eighth section */}
            < div className="flex flex-col max-w-screen justify-center md:space-y-14 space-y-8 items-center md:py-[60px] py-[50px] px-[20px]" >
                {/* Heading */}
                <div div  className=" w-full flex flex-col justify-center items-center text-center s xl:space-y-4" >
                ...
                {/* Cards Grid */}
                <div div  className="max-w-6xl w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8" >
                    {
                        [
                            {
                            ...
                            <div
                                key={idx}
                                className="bg-white border  cursor-pointer rounded-2xl overflow-hidden shadow-xl md:shadow-none hover:shadow-xl md:transform md:transition-transform md:duration-300 md:hover:scale-105"
                            >
                                {/* Image section */}
                                <div
                ...
                {/* Button */}
                < span className="bg-gray-50 shadow-md md:shadow-none border flex flex-row items-center gap-2 border-gray-200 px-4 sm:px-5 font-normal py-2 md:hover:bg-gray-200 md:hover:shadow-xl rounded-full transition cursor-pointer mt-4 sm:mt-8" >
            ...
            < div className="bg-gray-100 md:h-screen max-w-screen flex items-center justify-center md:px-4 px-[20px] py-[50px]" >
                <div className="md:space-y-14 space-y-8 md:flex md:flex-col items-center justify-center w-full">
                    ...
                    {/* Company Logos Strip - Fixed Version */}
                    <div className="w-full max-w-[1220px] bg-gradient-to-r from-gray-100 to-white p-6 md:p-10 shadow-xl overflow-hidden relative">
                        <style jsx>{`
                @keyframes scroll {
                            ...
                            {[...Array(2)].map((_, i) => (
                                ...
                                >
                                    {[
                                        "/logos/alberta.png",
                                        "/logos/aybiz.png",
                                        "/logos/caringadoptions.png",
                                        "/logos/cloudittekz.png",
                                        "/logos/enlightias.png",
                                        "/logos/haystravel.png",
                                        "/logos/legalbirbal.png",
                                        "/logos/onefinance.png",
                                        "/logos/rareminted.png",
                                        "/logos/sayearth.png",
                                        "/logos/sms.png",
                                        "/logos/tejimandi.png",
                                        "/logos/widgets.png",
                                        ...
                                        "/logos/pitchdeck.png",
                                        "/logos/ridebuddy.png",
                                        "/logos/scholarias.png",
                                        "/logos/takeoff.png",
                                        "/logos/thebuy.png",
                                        "/logos/anveshan.png",
                                        "/logos/bsm.png",
                                        "/logos/cloudit.png",
                                        "/logos/edemnortgage.png",
                                        "/logos/gurjarapp.png",
                                        "/logos/infowebusa.jpg",
                                        "/logos/mytelegrow.png",
                                        "/logos/planet.png",
                                        "/logos/rostamani.png",
                                        "/logos/selfdrivencr.png",
                                        "/logos/techrevol.png",
                                        "/logos/vision.png"
                                    ].map((logoPath, idx) => (
                                        <div
            ...
            {/* tenth section */}
            < div className="flex md:h-screen max-w-screen flex-col justify-center space-y-14 items-center md:py-[80px] py-[50px] md:px-4 px-[20px] bg-gradient-to-b from-white via-[#d8b4fe] to-[#a855f7]" >
            ...
            < footer className="bg-gray-100 max-w-screen text-gray-400 md:text-base md:px-4 px-[20px] md:pt-12 py-[20px] md:pb-[50px] border-t" >
                ...
                <div className=" mx-auto flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0 text-xs sm:text-sm">
                    ...
                    <div className="flex flex-wrap justify-center md:justify-end gap-4 text-[8px] md:text-[10px] lg:text-sm">
