    ...
    return (
        <>
            ...
            >
                ...
                <h1 className="bg-gray-50 border-gray-800 border md:border-gray-200 px-5 font-normal py-1 md:hover:bg-gray-200 md:hover:shadow-xl rounded-full transition cursor-pointer">
                    View All Services
                </h1>
            </div>
            ...
            >
                ...
                <p className="text-gray-400 md:text-lg text-xs text-center font-normal md:max-w-2xl">
                    Our global team delivers exceptional solutions and maintains an industry-leading client satisfaction rate, powering digital transformation across 17+ countries.
                </p>
            </div>
